...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creators can see their posts' do
      post1 =  Post.create(date: Date.today, rationale: "post1 rationale", user_id: @user.id) #FactoryGirl.build_stubbed(:post)
      post2 =  Post.create(date: Date.today, rationale: "post2 rationale", user_id: @user.id) #FactoryGirl.build_stubbed(:second_post)
